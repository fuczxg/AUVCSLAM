...
nsplug vehicle_bhv.meta AUV_1.bhv -f ${FLAGS} VEHICLE_NAME=AUV_1 MISSION_ROOT=${MISSION_ROOT} RUNTYPE=${RUNTYPE}
echo "      * built new vehicle BHV file from plugs"

rm -f AUV_2.bhv
#echo "      * removed the existing AUV_2 BHV file"

nsplug vehicle_bhv.meta AUV_2.bhv -f ${FLAGS} VEHICLE_NAME=AUV_2 MISSION_ROOT=${MISSION_ROOT} RUNTYPE=${RUNTYPE}
...
nsplug vehicle_moos.meta AUV_1.moos -f ${FLAGS} VEHICLE_NAME=AUV_1 MISSION_ROOT=${MISSION_ROOT} RUNTYPE=${RUNTYPE}
echo "      * built new vehicle MOOS file from plugs"

rm -f AUV_2.moos
#echo "      * removed the existing AUV_2 MOOS file"

nsplug vehicle_moos.meta AUV_2.moos -f ${FLAGS} VEHICLE_NAME=AUV_2 MISSION_ROOT=${MISSION_ROOT} RUNTYPE=${RUNTYPE}
...
lcm-spy --lcm-url=udpm://239.255.76.56:7662 >& /dev/null & 
sleep 1
